 ...
 */
final class Version20190823072829 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Feed (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, content VARCHAR(400) NOT NULL, likes INT DEFAULT NULL, createdAt DATETIME NOT NULL, INDEX IDX_8372EB95A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE FeedComment (id INT AUTO_INCREMENT NOT NULL, feed_id INT DEFAULT NULL, user_id INT DEFAULT NULL, content VARCHAR(400) NOT NULL, createdAt DATETIME NOT NULL, INDEX IDX_E644735051A5BC03 (feed_id), INDEX IDX_E6447350A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE Feed ADD CONSTRAINT FK_8372EB95A76ED395 FOREIGN KEY (user_id) REFERENCES User (id)');
        $this->addSql('ALTER TABLE FeedComment ADD CONSTRAINT FK_E644735051A5BC03 FOREIGN KEY (feed_id) REFERENCES Feed (id)');
        $this->addSql('ALTER TABLE FeedComment ADD CONSTRAINT FK_E6447350A76ED395 FOREIGN KEY (user_id) REFERENCES User (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE FeedComment DROP FOREIGN KEY FK_E644735051A5BC03');
