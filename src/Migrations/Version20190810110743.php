 ...
 */
final class Version20190810110743 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE userparameters ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE userparameters ADD CONSTRAINT FK_C9D61F0FA76ED395 FOREIGN KEY (user_id) REFERENCES User (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C9D61F0FA76ED395 ON userparameters (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE UserParameters DROP FOREIGN KEY FK_C9D61F0FA76ED395');
        $this->addSql('DROP INDEX UNIQ_C9D61F0FA76ED395 ON UserParameters');
        $this->addSql('ALTER TABLE UserParameters DROP user_id');
    }
}
