 ...
 */
final class Version20190809172422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP userParameters');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE User ADD userParameters VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
