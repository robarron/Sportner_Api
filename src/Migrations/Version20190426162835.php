 ...
 */
final class Version20190426162835 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD firstName VARCHAR(255) DEFAULT NULL, ADD lastName VARCHAR(255) DEFAULT NULL, ADD sexe VARCHAR(255) DEFAULT NULL, ADD phoneNumber VARCHAR(255) DEFAULT NULL, ADD age INT DEFAULT NULL, ADD description VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE User DROP firstName, DROP lastName, DROP sexe, DROP phoneNumber, DROP age, DROP description');
    }
}
