 ...
 */
final class Version20190810061815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE userparameters user_parameters_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE User CHANGE user_parameters_id userParameters VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
