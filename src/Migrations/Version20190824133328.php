 ...
 */
final class Version20190824133328 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE userlikecomment CHANGE user_id user_id INT DEFAULT NULL, CHANGE feedComment_id feedComment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE userlikefeed CHANGE user_id user_id INT DEFAULT NULL, CHANGE feed_id feed_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE UserLikeComment CHANGE user_id user_id INT NOT NULL, CHANGE feedComment_id feedComment_id INT NOT NULL');
        $this->addSql('ALTER TABLE UserLikeFeed CHANGE user_id user_id INT NOT NULL, CHANGE feed_id feed_id INT NOT NULL');
    }
}
