 ...
 */
final class Version20190820080639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `match` DROP FOREIGN KEY FK_BB9AEA01441B8B65');
        $this->addSql('DROP INDEX IDX_BB9AEA01441B8B65 ON `match`');
        $this->addSql('ALTER TABLE `match` CHANGE user2_id second_user_id INT NOT NULL');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_BB9AEA01B02C53F8 FOREIGN KEY (second_user_id) REFERENCES User (id)');
        $this->addSql('CREATE INDEX IDX_BB9AEA01B02C53F8 ON `match` (second_user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `Match` DROP FOREIGN KEY FK_BB9AEA01B02C53F8');
        $this->addSql('DROP INDEX IDX_BB9AEA01B02C53F8 ON `Match`');
        $this->addSql('ALTER TABLE `Match` CHANGE second_user_id user2_id INT NOT NULL');
        $this->addSql('ALTER TABLE `Match` ADD CONSTRAINT FK_BB9AEA01441B8B65 FOREIGN KEY (user2_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_BB9AEA01441B8B65 ON `Match` (user2_id)');
    }
}
