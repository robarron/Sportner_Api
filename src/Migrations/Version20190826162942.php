 ...
 */
final class Version20190826162942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Event (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, organizer VARCHAR(255) DEFAULT NULL, startDate DATETIME DEFAULT NULL, place VARCHAR(255) DEFAULT NULL, sportType VARCHAR(255) DEFAULT NULL, interestedNumber INT DEFAULT NULL, participateNumber INT DEFAULT NULL, ticketingSiteLink VARCHAR(255) DEFAULT NULL, picture VARCHAR(65000) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
