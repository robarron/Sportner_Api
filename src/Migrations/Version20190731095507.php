 ...
 */
final class Version20190731095507 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD facebookId INT DEFAULT NULL, ADD createdFromFacebook TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE User DROP facebookId, DROP createdFromFacebook');
    }
}
