 ...
 */
final class Version20190819210752 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `Match` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, user2_id INT NOT NULL, INDEX IDX_BB9AEA01A76ED395 (user_id), INDEX IDX_BB9AEA01441B8B65 (user2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE MatchProposition (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, user_wanted_id INT NOT NULL, INDEX IDX_74380CADA76ED395 (user_id), INDEX IDX_74380CAD59C66B57 (user_wanted_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE `Match` ADD CONSTRAINT FK_BB9AEA01A76ED395 FOREIGN KEY (user_id) REFERENCES User (id)');
        $this->addSql('ALTER TABLE `Match` ADD CONSTRAINT FK_BB9AEA01441B8B65 FOREIGN KEY (user2_id) REFERENCES User (id)');
        $this->addSql('ALTER TABLE MatchProposition ADD CONSTRAINT FK_74380CADA76ED395 FOREIGN KEY (user_id) REFERENCES User (id)');
        $this->addSql('ALTER TABLE MatchProposition ADD CONSTRAINT FK_74380CAD59C66B57 FOREIGN KEY (user_wanted_id) REFERENCES User (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE MatchProposition');
        $this->addSql('DROP INDEX log_class_lookup_idx ON ext_log_entries');
        $this->addSql('DROP INDEX log_user_lookup_idx ON ext_log_entries');
        $this->addSql('DROP INDEX log_version_lookup_idx ON ext_log_entries');
