 ...
 */
final class Version20190809145924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE userparameters ADD MatchPush TINYINT(1) NOT NULL, ADD MsgPush TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE UserParameters DROP MatchPush, DROP MsgPush');
    }
}
