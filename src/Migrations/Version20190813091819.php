 ...
 */
final class Version20190813091819 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sponsorshipcode ADD partnership_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sponsorshipcode ADD CONSTRAINT FK_690D64DE6AE7F85 FOREIGN KEY (partnership_id) REFERENCES User (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE SponsorshipCode DROP FOREIGN KEY FK_690D64DE6AE7F85');
        $this->addSql('DROP INDEX UNIQ_690D64DE6AE7F85 ON SponsorshipCode');
        $this->addSql('ALTER TABLE SponsorshipCode DROP partnership_id');
    }
}
