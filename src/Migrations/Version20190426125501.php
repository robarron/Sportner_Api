 ...
 */
final class Version20190426125501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD base64 VARCHAR(65535) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Image DROP base64, CHANGE image image LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
